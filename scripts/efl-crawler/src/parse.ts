...
import { parseEflDateTime } from "./dates.js";
...
/**
 * Parse the EFL planned outages HTML table.
 * Columns: Region | Area | Start Time | End time
 */
    ...
    $(table)
      ...
      .each((__, tr) => {
        ...
        if (!startTime || !endTime) {
          console.warn(`  ⚠ Skip row (bad dates): ${region.slice(0, 40)}…`);
          return;
        }
